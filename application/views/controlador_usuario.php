...
<body>
	<div id="container">
		...
		<center>
		<table>
		<tr><th>Nombre</th><th>Apellido</th><th>Correo</th><th>Aprobar</th><th>Rechazar</th></tr>
		<?php
			for($i=0;$i<count($result);$i++){
				if($i%2==1){
					echo "<tr class=\"par\"><td>";
					echo $result[$i]->nombre."</td><td>".$result[$i]->apellidos."</td><td>".$result[$i]->correo."</td><td><a href=\"".base_url('index.php/controlador_usuario')."/AprobarUsuario/".$result[$i]->usuario."\"><img src='".base_url()."images/aprobar.png'></img></a></td><td><a href=\"".base_url('index.php/controlador_usuario')."/RechazarUsuario/".$result[$i]->usuario."\"><img src='".base_url()."images/rechazar.png'></img></a></td></tr>\n";
				}
				else{
					echo "<tr><td>";
					echo $result[$i]->nombre."</td><td>".$result[$i]->apellidos."</td><td>".$result[$i]->correo."</td><td><a href=\"".base_url('index.php/controlador_usuario')."/AprobarUsuario/".$result[$i]->usuario."\"><img src='".base_url()."images/aprobar.png'></img></a></td><td><a href=\"".base_url('index.php/controlador_usuario')."/RechazarUsuario/".$result[$i]->usuario."\"><img src='".base_url()."images/rechazar.png'></img></a></td></tr>\n";
