		...
		<?php
			for($i=0;$i<count($result);$i++){
				if($i%2==1){
					...
					echo "<a href=\"".base_url('index.php/controlador_archivo')."/CargarArchivo/".utf8_decode($result[$i]->archivo_name)."\">".utf8_decode($result[$i]->archivo_name)."</a></td><td>".$result[$i]->ult_etiq."</td><td>".$result[$i]->usuario_etiq."</td><td>".$result[$i]->ult_marc."</td><td>".$result[$i]->usuario_marc."</td><td><a href=\"".base_url('index.php/controlador_bitacora')."/MostrarBitacoras/".utf8_decode($result[$i]->archivo_name)."\"><img src='".base_url()."images/bitacora.png'></img></a></td><td><a href=\"".base_url('index.php/controlador_archivo')."/EliminarArchivo/".utf8_decode($result[$i]->archivo_name)."\"><img src='".base_url()."images/rechazar.png'></img></a></td></tr>\n";
				}
				else{
					if($result[$i]->ult_etiq == "0000-00-00")
						$result[$i]->ult_etiq = "";
